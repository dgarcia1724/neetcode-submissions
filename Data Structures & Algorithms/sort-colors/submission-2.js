    ...
    sortColors(nums) {
        ...
        // so might look like [0,0,1,1,i,r,2] when i passes r we are done.
            ...
            if (nums[i] === 2) {
                swap(i, r);
                r--;
                i-=1; // To prevent i from moving on & potentially skipping a 0 (that was swapped there when i encountered a 2)
            }

            // No need for i-= 1 when l += 1 bc everything before i has already been evaluated 
